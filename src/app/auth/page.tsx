...
export default function AuthPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#343541] p-4">
      <div className="w-full max-w-[400px]">
        {/* Close button */}
        <div className="flex justify-end mb-2">
          <Link href="/" className="p-2 text-gray-400 hover:text-white rounded-full transition-colors">
